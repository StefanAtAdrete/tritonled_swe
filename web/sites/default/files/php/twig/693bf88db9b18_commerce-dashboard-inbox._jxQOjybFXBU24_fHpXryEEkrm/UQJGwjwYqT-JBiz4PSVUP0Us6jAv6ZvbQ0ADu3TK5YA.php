...
class __TwigTemplate_fa0d0dfcdb7c7777c0135ff324f4d575 extends Template
{
    ...
    ";
        ...
        if ((($tmp = ($context["unread_text"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            ...
            if ((isset($context["canvas_is_preview"]) && $context["canvas_is_preview"]) && array_key_exists("canvas_uuid", $context)) {
                if (array_key_exists("canvas_slot_ids", $context) && in_array("unread_text", $context["canvas_slot_ids"], TRUE)) {
                    yield \sprintf('<!-- canvas-slot-%s-%s/%s -->', "start", $context["canvas_uuid"], "unread_text");
                } else {
                    yield \sprintf('<!-- canvas-prop-%s-%s/%s -->', "start", $context["canvas_uuid"], "unread_text");
                }
            }
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ($context["unread_text"] ?? null), "html", null, true);
            if ((isset($context["canvas_is_preview"]) && $context["canvas_is_preview"]) && array_key_exists("canvas_uuid", $context)) {
                if (array_key_exists("canvas_slot_ids", $context) && in_array("unread_text", $context["canvas_slot_ids"], TRUE)) {
                    yield \sprintf('<!-- canvas-slot-%s-%s/%s -->', "end", $context["canvas_uuid"], "unread_text");
                } else {
                    yield \sprintf('<!-- canvas-prop-%s-%s/%s -->', "end", $context["canvas_uuid"], "unread_text");
                }
            }
            yield "</h4>
    ";
...
";
    ...
    {
        return array (  145 => 32,  140 => 30,  135 => 27,  129 => 24,  126 => 23,  123 => 22,  110 => 18,  104 => 16,  102 => 15,  97 => 13,  93 => 12,  89 => 11,  82 => 10,  78 => 9,  74 => 7,  54 => 5,  52 => 4,  48 => 3,  44 => 1,);
    }
