...
class __TwigTemplate_7cb09aed279fac5b39eb091d9f8e8502 extends Template
{
      ...
      ";
          ...
          ";
                ...
                if (((($_v21 = ($context["item_id"] ?? null)) && is_array($_v21) || $_v21 instanceof ArrayAccess && in_array($_v21::class, CoreExtension::ARRAY_LIKE_CLASSES, true) ? ($_v21[0] ?? null) : CoreExtension::getAttribute($this->env, $this->source, ($context["item_id"] ?? null), 0, [], "array", false, false, true, 63)) == "toolbar-id--toolbar-icon-user")) {
                    ...
                    yield "            ";
                    if ((isset($context["canvas_is_preview"]) && $context["canvas_is_preview"]) && array_key_exists("canvas_uuid", $context)) {
                        if (array_key_exists("canvas_slot_ids", $context) && in_array("user_picture", $context["canvas_slot_ids"], TRUE)) {
                            yield \sprintf('<!-- canvas-slot-%s-%s/%s -->', "start", $context["canvas_uuid"], "user_picture");
                        } else {
                            yield \sprintf('<!-- canvas-prop-%s-%s/%s -->', "start", $context["canvas_uuid"], "user_picture");
                        }
                    }
                    yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ($context["user_picture"] ?? null), "html", null, true);
                    if ((isset($context["canvas_is_preview"]) && $context["canvas_is_preview"]) && array_key_exists("canvas_uuid", $context)) {
                        if (array_key_exists("canvas_slot_ids", $context) && in_array("user_picture", $context["canvas_slot_ids"], TRUE)) {
                            yield \sprintf('<!-- canvas-slot-%s-%s/%s -->', "end", $context["canvas_uuid"], "user_picture");
                        } else {
                            yield \sprintf('<!-- canvas-prop-%s-%s/%s -->', "end", $context["canvas_uuid"], "user_picture");
                        }
                    }
                    yield "
          ";
...
";
    ...
    {
        return array (  233 => 82,  230 => 81,  224 => 80,  215 => 75,  211 => 73,  206 => 71,  201 => 70,  199 => 69,  194 => 68,  188 => 66,  168 => 64,  166 => 63,  158 => 62,  155 => 61,  152 => 59,  150 => 56,  147 => 55,  144 => 54,  142 => 53,  139 => 52,  133 => 51,  130 => 50,  127 => 49,  124 => 48,  120 => 47,  117 => 46,  114 => 45,  111 => 44,  108 => 43,  104 => 42,  85 => 40,  81 => 39,  77 => 38,  74 => 37,  70 => 35,  68 => 34,  64 => 32,  62 => 31,  59 => 29,  56 => 27,  55 => 26,  47 => 25,  44 => 23,);
    }
