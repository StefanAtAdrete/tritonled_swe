 ...
 */
class VadoGroupLazyBuilders extends ProductLazyBuilders {
   ...
   */
  public function addToCartWithAddOnsForm($product_id, $view_mode, $combine) {
    ...
    $form_object = $this->entityTypeManager->getFormObject('commerce_order_item', 'vado_group_add_to_cart');
  ...
  public static function trustedCallbacks() {
    return ['addToCartWithAddOnsForm'];
  }
