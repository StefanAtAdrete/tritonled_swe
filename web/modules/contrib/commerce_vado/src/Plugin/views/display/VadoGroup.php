 ...
 *
 * "commerce_vado_group_display" is a custom property.
 *
 ...
 *   admin = @Translation("Vado group source"),
 *   help = @Translation("Builds the title to display for commerce vado group items."),
 *   theme = "views_view",
 *   register_theme = FALSE,
 *   uses_menu_links = FALSE,
 *   base = {"commerce_vado_group"},
 *   commerce_vado_group_display = TRUE
 * )
 */
class VadoGroup extends DisplayPluginBase {
  ...
  protected function defineOptions() {
    ...
    // 'fields'.
    $options['style']['contains']['type'] = ['default' => 'commerce_vado_group'];
    $options['defaults']['default']['style'] = FALSE;
    $options['row']['contains']['type'] = ['default' => 'commerce_vado_group'];
