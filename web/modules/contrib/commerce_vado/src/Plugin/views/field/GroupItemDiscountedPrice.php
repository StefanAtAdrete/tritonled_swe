...
/**
 * Field handler to display vado group item discounted price.
 *
 * @ingroup views_field_handlers
 *
 * @ViewsField("group_item_discounted_price")
 */
class GroupItemDiscountedPrice extends FieldPluginBase {
  ...
  /**
   * Constructs a GroupItemDiscountedPrice object.
   *
  ...
  public function render(ResultRow $values) {
    ...
    $group_item_discounted_price = $group_item_variation->getPrice()->multiply($group_item_discount_multiplier);

    return $this->currencyFormatter->format(
      $group_item_discounted_price->getNumber(),
      $group_item_discounted_price->getCurrencyCode(),
